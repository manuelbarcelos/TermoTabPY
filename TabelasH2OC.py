...
def TabelasH2OC():
    ...
    Plc = np.array([5, 10, 15, 20, 30, 50])

    TabPlc1 = np.array([[0, 0.0009977, 0.04, 5.03, 0.0001],
    ...
    TabPlc2 = np.array([[0, 0.0009952, 0.12, 10.07, 0.0003],
    ...
    TabPlc3 = np.array([[0, 0.0009928, 0.18, 15.07, 0.0004],
    ...
    TabPlc4 = np.array([[0, 0.0009904, 0.23, 20.03, 0.0005],
    ...
    TabPlc5 = np.array([[0, 0.0009857, 0.29, 29.86, 0.0003],
    ...
    TabPlc6 = np.array([[0, 0.0009767, 0.29, 49.13, 0.0010],
    ...
    n2 = np.array([15,17, 19, 20, 20, 20])
    m2 = np.array([5, 5, 5, 5, 5, 5])

    TabPlc = np.zeros((22, 5, 6))
    for i in range(6):
        for j in range(n2[i]):
            for k in range(m2[i]):
                TabPlc[j, k, i] = eval(f"TabPlc{i+1}[j, k]")
    

    TabPsvs = np.array([[0.01, 0.61169, 0.001091, 205.99, -333.40, 2707.9, 2374.5, -333.40, 2833.9, 2500.5, -1.2202, 10.374, 9.154],
                        [0, 0.61115, 0.001091, 206.17, -333.43, 2707.9, 2374.5, -333.43, 2833.9, 2500.5, -1.2204, 10.375, 9.154],
                        ...
                        [-6, 0.36873, 0.001090, 334.27, -345.94, 2712.2, 2366.2, -345.93, 2835.4, 2489.5, -1.2667, 10.613, 9.347],
                        ...
                        [-34, 0.02490, 0.001085, 4432.4, -400.72, 2728.1, 2327.4, -400.72, 2838.5, 2437.7, -1.4831, 11.869, 10.386],
                        [-36, 0.02004, 0.001085, 5460.1, -404.40, 2729.0, 2324.6, -404.40, 2838.4, 2434.0, -1.4986, 11.969, 10.470],
                        [-38, 0.01608, 0.001085, 6750.5, -408.07, 2729.9, 2321.8, -408.07, 2838.4, 2430.3, -1.5141, 12.071, 10.557],
                        [-40, 0.01285, 0.001084, 8376.7, -411.70, 2730.7, 2319.0, -411.70, 2838.3, 2426.6, -1.5296, 12.174, 10.644]])

    return Plc, TabPlc, TabPsvs